...
* [面试题](interview.md#面试题)
* [面试技巧](interview.md#面试技巧)
...
* [SpringBoot系列](https://github.%20com/zhonghuasheng/Tutorial/issues?q=label%3ASpringBoot+)
  * [SpringBoot 的启动原理](https://github.%20com/zhonghuasheng/Tutorial/issues/185)
* 为什么要使用 spring？
* 解释一下什么是 aop？
* 解释一下什么是 ioc？
* spring 有哪些主要模块？
...
* redis 为什么是单线程的？
* [redis在什么情况下会变慢？](../plugins/redis-1.md#目录)
* 什么是缓存穿透？怎么解决？
* redis 支持的数据类型有哪些？
...
* 常用的 jvm 调优的参数都有哪些？
  ...
  > Java线程执行native方法时程序计数器为空，如何确保native执行完后的程序执行的位置 native是非java代码编写的，比如C,C++, 它们无法在java编译时生成字节码，即JVM获取不到native实现，只能通过系统指令去调用native方法,所以执行native时程序计数器值为空undefined。native方法由原生平台直接执行，native方法执行后会退出\(栈帧pop\)，方法退出返回到被调用的地方继续执行程序。
...
* [千万级别的数据，如何更改表字段长度？](https://github.com/sharefuture1/Tutorial/tree/7549352525744252ab484c3dcf85953b82b413ec/database/database.md#百问)
