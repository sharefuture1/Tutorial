...
1. Partition tolerance 先看 Partition tolerance，中文叫做"分区容错"。

   ![](../../.gitbook/assets/partitiontolerance.png)
...
![](../../.gitbook/assets/consistency.png)

接下来，用户的读操作就会得到 v1。这就叫一致性。

![](../../.gitbook/assets/consistency-send.png)

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![](../../.gitbook/assets/consistency-conflict.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![](../../.gitbook/assets/consistency-sync.png)

这样的话，用户向 G2 发起读操作，也能得到 v1。

![](../../.gitbook/assets/consistency-done.png)
